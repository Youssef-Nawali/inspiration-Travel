...
const translations = {
  fr: {
    ...
    tr_sub: 'Depuis l\'Aéroport Tunis-Carthage ou l\'Aéroport Enfidha, nos chauffeurs professionnels vous conduisent partout en Tunisie. Confort, ponctualité, prix sur demande.',
    ...
    tr_enfidha_text: 'Les mêmes destinations et les mêmes tarifs s\'appliquent depuis l\'<strong style="color:var(--sand)">Aéroport International Enfidha-Hammamet</strong>. Pack 4 personnes · Véhicule climatisé · Chauffeur professionnel · <strong style="color:var(--gold)">Prix sur demande.</strong>',
    ...
    vip_label: 'Expérience VIP',
    vip_title: 'Un voyage<br><em>d\'exception</em>',
    vip_sub: 'Pour ceux qui recherchent l\'excellence absolue. Services exclusifs, véhicules premium, accompagnement personnalisé et accès privilégiés.',
    vip1_title: 'Transfert VIP Premium',
    vip1_desc: 'Véhicule haut de gamme (Mercedes Classe V, SUV luxe), chauffeur bilingue en costume, bouteille d\'eau fraîche, Wi-Fi embarqué. Ponctualité garantie.',
    vip2_title: 'Excursion Privée VIP',
    vip2_desc: 'Guide expert privé, itinéraire 100% personnalisé, accès exclusifs aux sites, déjeuner gastronomique inclus dans un restaurant de charme.',
    vip3_title: 'Immersion Soufie VIP',
    vip3_desc: 'Visite spirituelle avec accès privé aux zaouïas, rencontre personnelle avec un maître soufi, cérémonie de dhikr intime réservée à votre groupe.',
    vip4_title: 'Pack VIP Intégral',
    vip4_desc: 'Séjour clé en main : transferts luxe, excursions privées, hébergement 5 étoiles, conciergerie 24/7. Votre voyage de rêve, sans aucun souci.',
    vip_cta: 'Réserver mon expérience VIP',
    service_options: [
      'Excursion Tunis (prix sur demande)',
      'Excursion Kairouan · Sousse · Jem (prix sur demande)',
      'Excursion Sud Tunisien (prix sur demande)',
      'Transfert A/R Aéroport Carthage ↔ Hammamet (prix sur demande)',
      'Transfert A/R Aéroport Carthage ↔ Sousse (prix sur demande)',
      'Transfert A/R Aéroport Carthage ↔ Monastir (prix sur demande)',
      'Transfert A/R Aéroport Carthage ↔ Sud (prix sur demande)',
      'Transfert A/R Aéroport Enfidha (prix sur demande)',
      'Transfert A/R à Tunis (prix sur demande)',
      'Ziyara Soufie Tunis (prix sur demande)',
      'Ziyara Soufie Kairouan (prix sur demande)',
      'Transfert VIP Premium (prix sur demande)',
      'Excursion Privée VIP (prix sur demande)',
      'Immersion Soufie VIP (prix sur demande)',
      'Pack VIP Intégral (sur devis)',
      'Circuit Sur Mesure'
    ]
  },
  ...
  en: {
    ...
    tr_sub: 'From Tunis-Carthage Airport or Enfidha Airport, our professional drivers take you anywhere in Tunisia. Comfort, punctuality, prices on request.',
    ...
    tr_enfidha_text: 'The same destinations and same rates apply from <strong style="color:var(--sand)">Enfidha-Hammamet International Airport</strong>. Pack 4 persons · Air-conditioned vehicle · Professional driver · <strong style="color:var(--gold)">Price on request.</strong>',
    ...
    vip_label: 'VIP Experience',
    vip_title: 'An exceptional<br><em>journey</em>',
    vip_sub: 'For those who seek absolute excellence. Exclusive services, premium vehicles, personalised assistance and privileged access.',
    vip1_title: 'VIP Premium Transfer',
    vip1_desc: 'High-end vehicle (Mercedes V-Class, luxury SUV), bilingual suited driver, fresh water, onboard Wi-Fi. Punctuality guaranteed.',
    vip2_title: 'VIP Private Excursion',
    vip2_desc: 'Private expert guide, 100% personalised itinerary, exclusive site access, gourmet lunch included at a boutique restaurant.',
    vip3_title: 'VIP Sufi Immersion',
    vip3_desc: 'Spiritual visit with private access to zawiyas, personal meeting with a Sufi master, intimate dhikr ceremony reserved for your group.',
    vip4_title: 'Full VIP Package',
    vip4_desc: 'Turnkey stay: luxury transfers, private excursions, 5-star accommodation, 24/7 concierge. Your dream trip, worry-free.',
    vip_cta: 'Book my VIP experience',
    service_options: [
      'Tunis Excursion (price on request)',
      'Kairouan · Sousse · Jem Excursion (price on request)',
      'South Tunisia Excursion (price on request)',
      'Round Trip Carthage Airport ↔ Hammamet (price on request)',
      'Round Trip Carthage Airport ↔ Sousse (price on request)',
      'Round Trip Carthage Airport ↔ Monastir (price on request)',
      'Round Trip Carthage Airport ↔ South (price on request)',
      'Round Trip Enfidha Airport (price on request)',
      'Round Trip Tunis City (price on request)',
      'Sufi Ziyara Tunis (price on request)',
      'Sufi Ziyara Kairouan (price on request)',
      'VIP Premium Transfer (price on request)',
      'VIP Private Excursion (price on request)',
      'VIP Sufi Immersion (price on request)',
      'Full VIP Package (on quote)',
      'Custom Circuit'
    ]
  }
};
